...
<body>
    ...
    <div class="admin-container">
        ...
        <?php if (empty($peserta_list)): ?>
            <p>Belum ada peserta yang ditambahkan. Silakan <a href="tambah_peserta.php">tambah peserta baru</a>.</p>
        <?php else: ?>
            <table>
                <thead>
                    <tr>
        ...
        <?php endif; ?>
        <br>
        <a href="tambah_peserta.php" class="btn" style="display: inline-block; width: auto;">Tambah Peserta Baru</a>
    </div>
</body>
</html>
