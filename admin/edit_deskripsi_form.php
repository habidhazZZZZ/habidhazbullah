...
<body>
    ...
    <div class="admin-container form-container">
        ...
        <a href="kelola_konten.php?view=deskripsi">&larr; Kembali ke Daftar Deskripsi</a>
        ...
        <?php if ($deskripsi_item): ?>
            <form action="edit_deskripsi_form.php?id=<?php echo $deskripsi_id; ?>" method="POST" style="margin-top: 20px;">
