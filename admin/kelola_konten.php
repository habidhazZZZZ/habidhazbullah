...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="nav-tabs">
            <a href="?view=soal" class="<?php echo $view === 'soal' ? 'active' : ''; ?>">Kelola Soal</a>
            <a href="?view=deskripsi" class="<?php echo $view === 'deskripsi' ? 'active' : ''; ?>">Kelola Deskripsi Aspek</a>
        </div>
                ...
                <tbody>
                    <?php foreach ($soal_list as $soal): ?>
                        <tr>
                            ...
                            <td><a href="edit_soal_form.php?id=<?php echo $soal['id']; ?>" class="action-btn">Edit</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
                ...
                <tbody>
                    <?php foreach ($deskripsi_list as $deskripsi): ?>
                        <tr>
                            ...
                            <td><a href="edit_deskripsi_form.php?id=<?php echo $deskripsi['id']; ?>" class="action-btn">Edit</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
